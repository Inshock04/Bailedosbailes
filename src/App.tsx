...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* ========================================================================= */}
      <div className="fixed bottom-3 inset-x-0 z-[100] pointer-events-none flex justify-center items-center px-2 md:inset-x-auto md:left-3 md:top-1/2 md:-translate-y-1/2 md:bottom-auto md:block">
        <nav 
          ref={leftSidebarRef}
          aria-label="Menu de Navegação Vermelho Brilhoso"
          className="pointer-events-auto flex flex-row md:flex-col items-center justify-center gap-1.5 sm:gap-2.5 md:gap-1.5 bg-[#0c0614]/90 md:bg-transparent backdrop-blur-md md:backdrop-blur-none px-2.5 sm:px-3 py-1.5 md:p-0.5 border border-[#ff1e38]/40 md:border-none shadow-[0_0_25px_rgba(0,0,0,0.85)] md:shadow-none select-none max-w-[calc(100vw-1rem)]"
        >
          {leftSidebarIcons.map((item) => {
            ...
            return (
              <button
                ...
                className={`left-icon-btn group relative w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 flex items-center justify-center outline-none border ${
                  isActive 
      ...
      {/* ========================================================================= */}
      <div className="relative z-30 w-full min-h-screen flex justify-center md:justify-end items-start md:items-center pointer-events-none p-2 sm:p-3 md:p-4 pt-2 sm:pt-3 md:pt-4 pb-20 md:pb-4">
        ...
        {isCardMinimized ? (
          <div className="pointer-events-auto self-start sm:self-center md:self-center my-0 md:my-auto flex flex-col items-center sm:items-end gap-1.5">
            <button
              ...
              className="bg-[#0c0614]/95 border-2 border-[#ff3344] text-[#ff3344] hover:text-white px-3 py-2 font-pixel text-[10px] sm:text-[12px] tracking-wider shadow-[0_0_20px_rgba(255,51,68,0.6)] flex items-center gap-2 cursor-pointer active:scale-95 transition-all"
            >
            ...
            <button
              ...
              className="bg-[#991b1b] hover:bg-[#b91c1c] text-white px-3 py-1.5 font-pixel text-[9px] sm:text-[10px] tracking-wider border border-[#ef4444] shadow-[0_0_15px_rgba(239,68,68,0.5)] cursor-pointer"
            >
              COMPRAR INGRESSO
            </button>
          </div>
          ...
          <aside 
            ref={rightSidebarRef}
            className="relative pointer-events-auto w-full max-w-[96vw] sm:max-w-[94vw] md:max-w-[280px] lg:max-w-[310px] bg-[#0c0614]/95 backdrop-blur-md border-2 border-[#361c4d] shadow-[0_0_30px_rgba(0,0,0,0.95)] flex flex-col justify-between p-2.5 sm:p-3 md:p-3.5 my-0 md:my-auto max-h-[85vh] md:max-h-[92vh] overflow-y-auto overflow-x-hidden custom-scrollbar select-none"
          >
            ...
            <div className="relative z-10 sidebar-item-anim border-b-2 border-[#2a133d] pb-2 mb-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="font-pixel text-[9px] sm:text-[10px] text-[#ef4444] tracking-widest uppercase flex items-center gap-1 font-bold">
                    <PixelSkull size={11} color="#ef4444" />
                    <span>HALLOWEEN</span>
                  </span>
                  <span className="bg-[#1f0a17] border border-[#7f1d1d] px-1.5 py-0.5 font-pixel text-[8px] sm:text-[9px] text-[#fca5a5]">
                    2026
                  </span>
                  <span className="hidden sm:inline-block font-mono text-[9px] sm:text-[10px] text-[#a855f7]">
                    • 31 OUT • 22H
                  </span>
                </div>

                <div className="flex items-center gap-1.5">
                  <span className="text-[#ef4444] font-pixel text-[9px] sm:text-[10px] font-bold sm:hidden">
                    31 OUT • 22H
                  </span>
                  ...
                  <button
                    ...
                    className="px-2 py-0.5 bg-[#2a133d] hover:bg-[#ff3344] text-[#d1d5db] hover:text-white font-pixel text-[10px] transition-colors cursor-pointer"
                  >
                    —
                  </button>
                </div>
              ...
              <div className="flex flex-wrap items-baseline justify-between gap-1 mt-1">
                <div className="flex items-baseline gap-2">
                  <h2 className="neon-ahs-title font-pixel text-[10px] sm:text-[11px] md:text-[12px] text-[#ff3344] font-black tracking-wider leading-tight">
                    AMERICAN HORROR STORY
                  </h2>
                  <h1 className="neon-triplex-title font-pixel text-sm sm:text-base md:text-lg text-[#f59e0b] font-black tracking-wider leading-none">
                    THE TRIPLEX
                  </h1>
                </div>
                <span className="text-[#a855f7] flex items-center gap-0.5 text-[9px] sm:text-[10px] font-pixel">
                  <PixelPin size={10} color="#a855f7" />
                  <span>SÃO PAULO</span>
                </span>
              </div>
            </div>
            ...
            <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-2">
              ...
              <div className="space-y-2">
                ...
                <div className="sidebar-item-anim">
                  <button
                    onClick={() => handleOpenSection('tickets')}
                    className="w-full pixel-btn bg-[#991b1b] hover:bg-[#b91c1c] active:bg-[#7f1d1d] text-white py-2 px-3 font-pixel text-[10px] sm:text-[11px] tracking-wider font-bold flex items-center justify-center gap-2 border-2 border-[#ff3344] shadow-[0_0_15px_rgba(239,68,68,0.5)] cursor-pointer"
                  >
                ...
                <div className="sidebar-item-anim bg-[#12071f] border border-[#361c4d] p-1.5 text-center shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
                  <div className="flex items-center justify-between px-1 mb-1">
                    <span className="font-pixel text-[8px] sm:text-[9px] text-[#a855f7] tracking-widest uppercase font-bold">
                      CONTAGEM REGRESSIVA
                    </span>
                    <span className="font-pixel text-[8px] sm:text-[9px] text-[#ef4444] font-bold">AO VIVO</span>
                  </div>
                  <div className="grid grid-cols-4 gap-1">
                    <div className="bg-[#180b29] border border-[#4c1d95] p-1 flex flex-col items-center">
                      <span className="font-pixel text-xs sm:text-sm md:text-base text-white font-bold">{timeLeft.days}</span>
                      <span className="font-pixel text-[7px] sm:text-[8px] text-[#9ca3af]">DIAS</span>
                    </div>
                    <div className="bg-[#180b29] border border-[#4c1d95] p-1 flex flex-col items-center">
                      <span className="font-pixel text-xs sm:text-sm md:text-base text-white font-bold">{timeLeft.hours}</span>
                      <span className="font-pixel text-[7px] sm:text-[8px] text-[#9ca3af]">HRS</span>
                    </div>
                    <div className="bg-[#180b29] border border-[#4c1d95] p-1 flex flex-col items-center">
                      <span className="font-pixel text-xs sm:text-sm md:text-base text-white font-bold">{timeLeft.minutes}</span>
                      <span className="font-pixel text-[7px] sm:text-[8px] text-[#9ca3af]">MIN</span>
                    </div>
                    <div className="bg-[#180b29] border border-[#4c1d95] p-1 flex flex-col items-center">
                      <span className="font-pixel text-xs sm:text-sm md:text-base text-[#ef4444] font-bold">{timeLeft.seconds}</span>
                      <span className="font-pixel text-[7px] sm:text-[8px] text-[#9ca3af]">SEG</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="sidebar-item-anim bg-[#11071c] border border-[#22c55e]/70 p-2 flex flex-col justify-between space-y-1.5">
                <div className="flex items-center justify-between">
                  <span className="font-pixel text-[9px] sm:text-[10px] text-[#86efac] tracking-wider uppercase font-bold flex items-center gap-1">
                    <PixelPin size={11} color="#22c55e" />
                    <span>LOCALIZAÇÃO</span>
                  </span>
                  <span className="font-pixel text-[8px] sm:text-[9px] text-[#4ade80]">ITAIM PAULISTA • SP</span>
                </div>

                {/* Venue Address Info */}
                <div className="bg-[#0b1710] border border-[#166534] p-1.5 space-y-0.5">
                  <div className="font-pixel text-[10px] sm:text-[11px] text-[#bbf7d0] font-bold leading-tight">
                    THE TRIPLEX
                  </div>
                  <div className="font-mono text-[9px] sm:text-[10px] text-[#86efac] leading-tight">
                ...
                <div className="grid grid-cols-2 gap-1.5 pt-0.5">
                  <a
                    ...
                    className="p-1.5 bg-[#052e16] hover:bg-[#14532d] active:bg-[#052e16] border border-[#22c55e] text-[#86efac] hover:text-white font-pixel text-[8px] sm:text-[9px] tracking-wider flex items-center justify-center gap-1 transition-all cursor-pointer text-center"
                  >
                    <PixelExternalLink size={10} color="#86efac" />
                    <span>MAPS</span>
                  </a>

                  <button
                    onClick={() => handleOpenSection('local')}
                    className="p-1.5 bg-[#180b29] hover:bg-[#2e1065] active:bg-[#180b29] border border-[#a855f7] text-[#e9d5ff] font-pixel text-[8px] sm:text-[9px] tracking-wider flex items-center justify-center gap-1 transition-all cursor-pointer text-center"
                  >
                    <PixelPin size={10} color="#c084fc" />
                    <span>VER MAPA</span>
                  </button>
                </div>
                ...
                <div className="border-t border-[#166534]/50 pt-1.5 mt-0.5">
                  <div className="flex items-center justify-between pb-1">
                    <span className="font-pixel text-[8px] sm:text-[9px] text-[#86efac] tracking-wider uppercase font-bold">
                      CANAIS OFICIAIS
                    </span>
                    <span className="font-mono text-[8px] sm:text-[9px] text-[#4ade80]">
                      ATENDIMENTO
                    </span>
                  </div>
            ...
            <div className="relative z-10 sidebar-item-anim mt-2 pt-2 border-t border-[#2a133d] flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-1.5 flex-1 min-w-[150px]">
                ...
                <button
                  ...
                  className={`flex-1 py-1 px-1.5 border flex items-center justify-between text-[8px] sm:text-[9px] font-pixel transition-all cursor-pointer ${
                    isMusicOn 
                ...
                <button
                  ...
                  className={`py-1 px-1.5 border text-[8px] sm:text-[9px] font-pixel transition-all cursor-pointer ${
                    isCrtOn 
                ...
                <button
                  ...
                  className="py-1 px-1.5 border text-[8px] sm:text-[9px] font-pixel transition-all cursor-pointer bg-[#180a14] border-[#7f1d1d] text-[#fca5a5] hover:border-[#ff3344] hover:bg-[#3b0710]"
                >
              ...
              <div className="flex items-center justify-end gap-1.5 text-[8px] sm:text-[9px] font-pixel text-[#9ca3af]">
                <button
