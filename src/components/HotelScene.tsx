...
// WebP optimized versions (much smaller file sizes)
import circusSceneryWebp from '../assets/images/freakshow_circus_scenery.webp';
import theTriplexHotelSceneryWebp from '../assets/images/the_triplex_hotel_1788309454235.webp';

// Original JPG fallbacks
...
export const HotelScene: React.FC<HotelSceneProps> = ({ currentScene = 'circus' }) => {
  ...
  useGSAP(() => {
    if (currentScene === 'circus') {
      if (isMobile) {
        // Mobile: single simplified pulsing glow (instead of 4 separate animations)
  ...
  }, { scope: containerRef, dependencies: [currentScene, isMobile] });
