      ...
      <div className="relative w-full max-w-xl bg-[#100818] border-2 border-[#a855f7] shadow-[0_0_35px_rgba(168,85,247,0.5)] rounded-xl p-4 sm:p-6 text-[#f3edf9] my-auto">
        ...
        <div className="space-y-3 font-mono text-xs sm:text-sm text-[#d1d5db]">
          <div className="bg-[#1b0d2d] border border-[#7e22ce] p-3 text-left">
            <span className="font-pixel text-[12px] sm:text-[13px] text-[#fde047] block mb-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <div className="bg-[#150720] border border-[#6b21a8] p-3">
              <span className="font-pixel text-[11px] sm:text-[12px] text-[#f43f5e] block mb-1">1. A CONDESSA</span>
            ...
            <div className="bg-[#150720] border border-[#6b21a8] p-3">
              <span className="font-pixel text-[11px] sm:text-[12px] text-[#fbbf24] block mb-1">2. VINTAGE NOIR</span>
            ...
            <div className="bg-[#150720] border border-[#6b21a8] p-3">
              <span className="font-pixel text-[11px] sm:text-[12px] text-[#34d399] block mb-1">3. ALL BLACK & GOTH</span>
          ...
          <div className="bg-[#241306] border border-[#d97706] p-3 flex items-start gap-2.5">
            ...
            <div>
              <span className="font-pixel text-[11px] sm:text-[12px] text-[#fef08a] block mb-0.5">CONCURSO DE FANTASIAS ÀS 02:30:</span>
          ...
          <div className="bg-[#240810] border border-[#7f1d1d] p-3 text-xs text-[#fca5a5]">
            <span className="font-pixel text-[11px] sm:text-[12px] text-[#ef4444] block mb-0.5">ITENS NÃO PERMITIDOS:</span>
        ...
        <div className="mt-4 pt-3 border-t border-[#581c87] flex justify-end">
          <button
            ...
            className="pixel-btn bg-[#7e22ce] hover:bg-[#9333ea] text-white px-5 py-2.5 font-pixel text-[12px] sm:text-[13px] font-bold"
          >
            ENTENDIDO
          </button>
        </div>
