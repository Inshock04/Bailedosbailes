  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center p-2 sm:p-4 bg-black/85 backdrop-blur-xs overflow-y-auto" style={{ paddingBottom: 'calc(5.5rem + env(safe-area-inset-bottom, 0px))' }}>
      <div className="relative w-full max-w-2xl bg-[#0e0712] border-2 border-[#d97706] shadow-[0_0_35px_rgba(217,119,6,0.5)] rounded-xl p-4 sm:p-6 text-[#f3edf9] my-auto">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="font-mono text-[12px] text-[#fbbf24]">
                Valores e promoções oficiais do evento
              </span>
            </div>
          </div>
          <button
        ...
        {/* Promotions Grid */}
        {promotions.length === 0 ? (
          <div className="py-12 px-4 text-center border-2 border-dashed border-[#5c2807] bg-[#140a13] my-4">
            <p className="font-pixel text-[12px] text-[#fbbf24] mb-1 tracking-wide">
              NENHUMA PROMOÇÃO ATIVA
            </p>
            <p className="text-[12px] text-[#9ca3af] font-mono">
              Não há promoções adicionais cadastradas no momento.
            </p>
          </div>
        ) : (
