...
async function main() {
  ...
  // 2. Admin inicial padrão (com hash bcrypt seguro)
  const defaultAdminEmail = process.env.INITIAL_ADMIN_EMAIL || 'admin@hotelcortez.com';
  const defaultAdminPassword = process.env.INITIAL_ADMIN_PASSWORD || 'Cortez@2026!Admin';
