...
// ----------------------------------------------------
interface Ticket {
  id: string; name: string; category: 'PISTA' | 'VIP' | 'CAMAROTE' | 'LOUNGE';
...
let tickets: Ticket[] = [
  {
    id: 't-pista', name: 'PISTA CORTEZ - OPEN BAR', category: 'PISTA',
    price: 50, originalPrice: 70, batch: '1º LOTE', available: 200, total: 200,
    features: ['Acesso ao Lobby e Salão Principal', 'Open Bar até 04:00', 'Copo oficial colecionável Hotel Cortez', 'Acesso a todas as atrações musicais'],
    drinksIncluded: ['Gin & Tônica', 'Vodka Smirnoff', 'Energético Baly', 'Caipirinha Velho Barreiro'],
    color: '#991b1b'
  },
  {
    id: 't-vip', name: 'VIP SUITE 64 - OPEN BAR PREMIUM', category: 'VIP',
    price: 110, originalPrice: 140, batch: '1º LOTE', available: 80, total: 80,
    features: ['Entrada preferencial sem filas', 'Acesso ao Mezanino VIP Suite 64', 'Open Bar Premium completo', 'Barbearia e maquiagem temática cortesia', '1 Welcome Shot Sangue da Condessa'],
    drinksIncluded: ['Whisky Red Label', 'Gin Tanqueray', 'Vodka Absolut', 'Cerveja Heineken', 'Energético Monster'],
    color: '#9333ea'
  },
  {
    id: 't-camarote', name: 'CAMAROTE COUNTESS - ALL INCLUSIVE', category: 'CAMAROTE',
    price: 180, originalPrice: 220, batch: 'ÚLTIMOS', available: 30, total: 30,
    features: ['Área reservada com visão panorâmica do palco', 'Garçom exclusivo no camarote', 'Open Food Finger foods & petiscos gourmet', 'Open Bar Super Premium', 'Brinde exclusivo comemorativo AHS'],
    drinksIncluded: ['Gin Hendricks', 'Vodka Ciroc', 'Whisky Black Label', 'Espumante Chandon', 'Drinks Autorais'],
    color: '#d97706'
  },
  {
    id: 't-lounge', name: 'LOUNGE PRIVATIVO PARA 10 PESSOAS', category: 'LOUNGE',
    price: 1200, originalPrice: 1500, batch: 'EXCLUSIVO', available: 4, total: 4,
    features: ['Espaço privativo com sofás e segurança', '10 Ingressos VIP inclusos', '3 Garrafas de Destilados Premium à escolha', '12 Red Bulls + 12 Águas', 'Atendimento de maître particular'],
...
const oracleCards = [
  { id: 'card-1', name: 'A CONDESSA (THE COUNTESS)', title: 'SANGUE E SEDUÇÃO', symbol: 'CHALICE', arcana: 'ARCANA III', description: 'Você foi abençoado com a imortalidade da noite. Beba do cálice sagrado do Cortez.', rewardText: '2 DRINKS POR R$25 (OU 50% NO SEGUNDO)', rewardCodePrefix: 'DRK25', discountType: 'PRICE', value: 'R$ 25,00' },
  { id: 'card-2', name: 'O CARA DE BORRACHA (RUBBER MAN)', title: 'O MISTÉRIO DO CORREDOR', symbol: 'EYE', arcana: 'ARCANA VII', description: 'As sombras do hotel conspiram a seu favor. Uma passagem secreta foi revelada.', rewardText: 'DESCONTO DE R$ 20,00 NO INGRESSO VIP', rewardCodePrefix: 'VIP20', discountType: 'PRICE', value: 'R$ 20,00 OFF' },
  { id: 'card-3', name: 'O FUNDADOR JAMES MARCH', title: 'O BANQUETE MACABRO', symbol: 'SKULL', arcana: 'ARCANA XIII', description: 'James Patrick March convida você para brindar na Sala de Jantar Secreta.', rewardText: '1 SHOT CORTESIA SANGUE DO CORTEZ NA ENTRADA', rewardCodePrefix: 'SHOTFREE', discountType: 'GIFT', value: 'SHOT GRÁTIS' },
  { id: 'card-4', name: 'O CORVO DA MEIA-NOITE', title: 'O PRESSÁGIO DOURADO', symbol: 'RAVEN', arcana: 'ARCANA IX', description: 'As asas negras trazem a sorte dos condenados. Celebre com seus aliados.', rewardText: 'BALDE DE CERVEJA POR R$ 45 (6 UNID)', rewardCodePrefix: 'BALDE45', discountType: 'PRICE', value: 'R$ 45,00' }
];
...
app.post('/api/oracle/draw', publicWriteLimiter, (req: Request, res: Response) => {
  ...
  if (!selectedCard) selectedCard = oracleCards[Math.floor(Math.random() * oracleCards.length)];
